    ...
    <div class="dashboard-content">
      <div class="row">
        <div class="col-12">
          ...
          @endif
          <form action="{{ route('pasien.update', $item->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="card">
              <div class="card-body">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="namaPasien" placeholder="Nama Pasien"
                            value="{{ $item->namaPasien }}">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                        <label for="alamat">Alamat</label>
                        <textarea class="form-control" name="alamat" placeholder="Alamat" rows="5">{{ $item->alamat }}
                                </textarea>
                    </div>
                  </div>
                  <div class="col-md-12">
